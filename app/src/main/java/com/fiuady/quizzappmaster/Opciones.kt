...
class Opciones : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todoschek.setOnCheckedChangeListener { _, _ ->
        ...
        ciencia_checkbox.setOnCheckedChangeListener { _, _ ->

            if(!ciencia_checkbox.isChecked&&todoschek.isChecked&&cine_checkbox.isChecked&&arte_checkbox.isChecked&&deporte_checkbox.isChecked&&musica_checkbox.isChecked&&videojuegos_checkbox.isChecked){
                todoschek.isEnabled=true
            }
        ...
        cine_checkbox.setOnCheckedChangeListener { _, _ ->
            if(ciencia_checkbox.isChecked&&todoschek.isChecked&&!cine_checkbox.isChecked&&arte_checkbox.isChecked&&deporte_checkbox.isChecked&&musica_checkbox.isChecked&&videojuegos_checkbox.isChecked){
        ...
        deporte_checkbox.setOnCheckedChangeListener { _, _ ->
            if(ciencia_checkbox.isChecked&&todoschek.isChecked&&cine_checkbox.isChecked&&arte_checkbox.isChecked&&!deporte_checkbox.isChecked&&musica_checkbox.isChecked&&videojuegos_checkbox.isChecked){
        ...
        musica_checkbox.setOnCheckedChangeListener { _, _ ->
        ...
        arte_checkbox.setOnCheckedChangeListener { _, _ ->
        ...
        videojuegos_checkbox.setOnCheckedChangeListener { _, _ ->
